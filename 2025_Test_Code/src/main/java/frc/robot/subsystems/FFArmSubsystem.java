  ...
  public void periodic() {
   ...
   // shoulderpid.setReference(armgoal,ControlType.kPosition);
    ...
    if (wristmotor.getAbsoluteEncoder().getPosition() > 40 && armgoal <30) {
      ...
      shouldermotor.setVoltage(MathUtil.clamp((armff.calculate(Math.toRadians(shoulderencoder.getPosition() + 38.4),0.8) + shoulderpid.calculate(shoulderencoder.getPosition(), armgoal)), -1.0, 7.0));
    }
  }
